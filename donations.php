        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12" id="donation-report">
...
<?php include "includes/footer.php"; ?>
    <script type="text/javascript">
        ...
        var buttons = new $.fn.dataTable.Buttons(donations, {
            buttons: [{
                extend: 'excelHtml5',
                title: 'Excel',
    ...
    <script type="text/javascript">
        ...
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Donation Report</title>');
